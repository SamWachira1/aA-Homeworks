module TieBreaker
    ...
    def compare_full_house(other_hand)
        ...
        if three == 0
            ...
            if two == 0
                high_card = card_without(set_card(3).value) &&
                            card_without(set_card(2).value)
                other_high_card = other_hand.card_without(set_card(3).value) &&
                                  other_hand.card_without(set_card(2).value)
