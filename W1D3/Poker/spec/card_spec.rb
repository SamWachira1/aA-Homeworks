...
describe Card do 
    describe "#initialize" do
        ...
        it "raises an error with an invalid suit" do
            expect{Card.new(:test, :five)}.to raise_error
        end
    ...
    describe "#<=>" do
        ...
        it "should return 1 when card has a higher value" do
        ...
        it "should return -1 when the card has a lower value" do
            expect(Card.new(:spades, :ten) <=> Card.new(:spades, :ace)).to eq(-1)
        end

        it "should return -1 when the card has same value but lower suit " do
