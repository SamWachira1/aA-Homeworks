...
describe Game do 
    ...
    describe '#initialize' do
        it "should should set up an empty pot" do 
    ...
    describe "#add_players" do
        it "should create a specified number of players and buy in amount" do
    ...
    describe "game_over?" do
        it "should return false if players still have money" do
    ...
    describe "#deal_cards" do
        ...
        describe "#add_to_pot" do
            it "should add the specified amount to pot" do
