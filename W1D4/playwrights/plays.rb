...
class Playwright
  attr_accessor :id, :name, :birth_year # remember to use these to change the instance var
    ...
    def self.all
      datas = PlayDBConnection.instance.execute("SELECT * FROM playwrights") #this comes in as a hash 
      datas.map {|datum| Playwright.new(datum)}  # this turns the data into an array
    end 
